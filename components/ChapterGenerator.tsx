    ...
    return (
        <div className="space-y-6 max-w-4xl mx-auto">
            <div className="bg-slate-800 p-6 rounded-xl shadow-lg">
                <h2 className="text-2xl font-bold mb-4 text-white">Gerador de Capítulos</h2>
                <p className="text-slate-400 mb-4">Gere capítulos de histórias únicos e cativantes com IA.</p>
                <textarea
                    placeholder="Descreva o que deve acontecer neste capítulo..."
